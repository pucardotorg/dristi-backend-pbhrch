...
@Component("ctcFileStoreHelper")
@Slf4j
public class CtcFileStoreHelper {
    ...
    @Autowired
    public CtcFileStoreHelper(RestTemplate restTemplate, Configuration configs, ServiceRequestRepository repository) {
