...
@Service("schedulerSmsNotificationService")
@Slf4j
public class SmsNotificationService {
    ...
    private final SchedulerServiceRequestHelper repository;

    @Autowired
    public SmsNotificationService(Configuration config, Producer producer, SchedulerServiceRequestHelper repository) {
        this.config = config;
