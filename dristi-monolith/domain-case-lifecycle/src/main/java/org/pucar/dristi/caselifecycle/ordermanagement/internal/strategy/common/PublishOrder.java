...
import static org.pucar.dristi.caselifecycle.ordermanagement.internal.config.ServiceConstants.SCHEDULED;
...
public class PublishOrder implements OrderUpdateStrategy {
    ...
    public CaseDiaryEntry execute(OrderRequest orderRequest) {
        ...
        return CaseDiaryEntry.builder()
                .tenantId(order.getTenantId())
                .entryDate(dateUtil.getEPochFromLocalDate(dateUtil.getLocalDateFromEpoch(dateUtil.getCurrentTimeInMilis())))
