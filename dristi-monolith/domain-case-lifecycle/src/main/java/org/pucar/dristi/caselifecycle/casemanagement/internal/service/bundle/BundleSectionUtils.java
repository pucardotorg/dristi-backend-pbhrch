...
public class BundleSectionUtils {
    ...
    public static String findAnyFileStoreId(List<org.pucar.dristi.common.models.Document> documents) {
        if (documents == null || documents.isEmpty()) return null;
        return documents.stream()
                .filter(Objects::nonNull)
                .map(org.pucar.dristi.common.models.Document::getFileStore)
                .filter(Objects::nonNull)
                .findFirst()
                .orElse(null);
    }
