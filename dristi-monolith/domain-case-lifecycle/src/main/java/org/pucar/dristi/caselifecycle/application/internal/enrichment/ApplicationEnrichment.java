package org.pucar.dristi.caselifecycle.application.internal.enrichment;
...
public class ApplicationEnrichment {
    ...
    @Autowired
    public ApplicationEnrichment(IdgenUtil idgenUtil, Configuration configuration, CaseUtil caseUtil, @Qualifier("commonDateUtil") DateUtil dateUtil) {
