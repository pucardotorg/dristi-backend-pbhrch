...
import static org.pucar.dristi.caselifecycle.scheduler.internal.config.ServiceConstants.INDIVIDUAL_SERVICE_EXCEPTION;

@Service("schedulerIndividualService")
@Slf4j
public class IndividualService {

    private final SchedulerIndividualUtil individualUtils;
    private final Configuration config;

    @Autowired
    public IndividualService(SchedulerIndividualUtil individualUtils, Configuration config) {
