...
import org.pucar.dristi.caselifecycle.scheduler.internal.web.models.OpenHearing;
import org.pucar.dristi.caselifecycle.scheduler.internal.web.models.inbox.*;
...
import static org.pucar.dristi.caselifecycle.scheduler.internal.config.ServiceConstants.EXTERNAL_SERVICE_EXCEPTION;
import static org.pucar.dristi.caselifecycle.scheduler.internal.config.ServiceConstants.SEARCHER_SERVICE_EXCEPTION;

@Component("schedulerInboxUtil")
@Slf4j
public class InboxUtil {
    ...
    public InboxUtil(ObjectMapper objectMapper, SchedulerServiceRequestHelper serviceRequestRepository, Configuration configuration, DateUtil dateUtil) {
