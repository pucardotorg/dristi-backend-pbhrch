...
import org.pucar.dristi.caselifecycle.scheduler.internal.web.models.PendingTask;
import org.pucar.dristi.caselifecycle.scheduler.internal.web.models.PendingTaskRequest;
...
import org.pucar.dristi.caselifecycle.scheduler.internal.web.models.inbox.Inbox;
...
@Component("schedulerPendingTaskUtil")
@Slf4j
public class PendingTaskUtil {
    ...
    public PendingTaskUtil(ObjectMapper objectMapper, Configuration configuration, RestTemplate restTemplate, SchedulerServiceRequestHelper serviceRequestRepository, DateUtil dateUtil, CaseUtil caseUtil, UserService userService, Configuration config) {
