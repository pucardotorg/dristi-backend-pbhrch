...
public class UserService {
    ...
    @Autowired
    public UserService(Configuration configuration, SchedulerServiceRequestHelper requestRepository, MultiStateInstanceUtil multiStateInstanceUtil) {
