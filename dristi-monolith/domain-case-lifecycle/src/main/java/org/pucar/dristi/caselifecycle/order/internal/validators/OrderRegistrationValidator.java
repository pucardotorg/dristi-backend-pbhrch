...
public class OrderRegistrationValidator {
    ...
    private void validateMDMSDocumentTypes(OrderRequest orderRequest) {
        String mdmsData = mdmsUtil.fetchMdmsDataAsString(orderRequest.getRequestInfo(), orderRequest.getOrder().getTenantId(), configuration.getOrderModule(), createMasterDetails());
