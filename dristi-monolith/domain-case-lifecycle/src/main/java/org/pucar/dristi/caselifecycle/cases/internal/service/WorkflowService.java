...
import static org.pucar.dristi.caselifecycle.cases.internal.config.ServiceConstants.MAKE_PAYMENT;
import static org.pucar.dristi.caselifecycle.cases.internal.config.ServiceConstants.WORKFLOW_SERVICE_EXCEPTION;
...
public class WorkflowService {
    ...
    public org.pucar.dristi.caselifecycle.cases.internal.web.models.ProcessInstance getCurrentWorkflow(RequestInfo requestInfo, String tenantId, String businessId) {
        try {
            RequestInfoWrapper requestInfoWrapper = RequestInfoWrapper.builder().requestInfo(requestInfo).build();
            StringBuilder url = getSearchURLForProcessInstanceWithParams(tenantId, businessId);
            Object res = repository.fetchResult(url, requestInfoWrapper);
            org.pucar.dristi.caselifecycle.cases.internal.web.models.ProcessInstanceResponse response = mapper.convertValue(res, org.pucar.dristi.caselifecycle.cases.internal.web.models.ProcessInstanceResponse.class);
