...
import org.pucar.dristi.caselifecycle.ordermanagement.internal.web.models.individual.IndividualSearch;
import org.pucar.dristi.caselifecycle.ordermanagement.internal.web.models.individual.IndividualSearchRequest;
...
public class PublishOrderSetBailTerms implements OrderUpdateStrategy {
    ...
    @Autowired
    public PublishOrderSetBailTerms(CaseUtil caseUtil, ApplicationUtil applicationUtil, JsonUtil jsonUtil, PendingTaskUtil pendingTaskUtil, IndividualUtil individualUtil, Configuration configuration) {
    ...
    public OrderRequest postProcess(OrderRequest orderRequest) {
        ...
        StringBuilder individualSearchUri = new StringBuilder(configuration.getIndividualHost())
                .append(configuration.getIndividualSearchEndPoint())
                .append("?limit=1&offset=0&tenantId=").append(order.getTenantId());
        String individualId = individualUtil.getIndividualId(individualSearchRequest, individualSearchUri);
