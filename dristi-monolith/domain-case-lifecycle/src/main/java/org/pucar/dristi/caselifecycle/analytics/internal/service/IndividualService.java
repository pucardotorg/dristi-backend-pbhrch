package org.pucar.dristi.caselifecycle.analytics.internal.service;
...
import org.pucar.dristi.caselifecycle.analytics.internal.web.models.IndividualSearch;
import org.pucar.dristi.caselifecycle.analytics.internal.web.models.IndividualSearchRequest;
...
@Service("analyticsIndividualService")
@Slf4j
public class IndividualService {
    ...
    public List<Individual> getIndividuals(RequestInfo requestInfo, List<String> uuids) throws CustomException {
        try {
            ...
            List<Individual> individual = individualUtils.getIndividualByIndividualId(individualSearchRequest, uri, Individual.class);
            if (individual != null) {
