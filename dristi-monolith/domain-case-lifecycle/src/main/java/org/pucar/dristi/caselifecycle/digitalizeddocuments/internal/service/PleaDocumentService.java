...
import org.pucar.dristi.caselifecycle.digitalizeddocuments.internal.enrichment.PleaEnrichment;
import org.pucar.dristi.common.kafka.Producer;
import org.pucar.dristi.caselifecycle.digitalizeddocuments.internal.util.CaseUtil;
import org.pucar.dristi.common.util.FileStoreUtil;
import org.pucar.dristi.common.util.UrlShortenerUtil;
import org.pucar.dristi.caselifecycle.digitalizeddocuments.internal.validators.PleaValidator;
...
public class PleaDocumentService implements DocumentTypeService {
    ...
    private void expireTheShorteningUrl(DigitalizedDocumentRequest digitalizedDocumentRequest) {
        DigitalizedDocument doc = digitalizedDocumentRequest.getDigitalizedDocument();
        urlShortenerUtil.expireTheUrl(doc.getShortenedUrl(), doc.getDocumentNumber());
    }
