...
import static org.pucar.dristi.caselifecycle.scheduler.internal.config.ServiceConstants.CAUSE_LIST_NOT_FOUND;
...
@Controller
@RequestMapping("/scheduler/causelist")
@Slf4j
public class CauseListApiController {
    ...
    @Autowired
    public CauseListApiController(CauseListService causeListService, ResponseInfoFactory responseInfoFactory) {
