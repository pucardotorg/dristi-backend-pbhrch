...
public class OpenapiApiControllerTest {
    ...
    public void testGetCaseByCNR_ValidInput_Success() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/OpenAPI/openapi/v1/{tenantId}/case/cnr/{cnrNumber}", tenantId, cnrNumber)
    ...
    public void testGetCaseByCaseNumber_ValidInput_Success() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/OpenAPI/openapi/v1/{tenantId}/case/{year}/{caseType}", tenantId, year, caseType)
    ...
    public void getCaseByCaseNumber_ValidInput_Success() throws Exception {
        ...
        // Act & Assert
        mockMvc.perform(get("/OpenAPI/openapi/v1/{tenantId}/case/{year}/{caseType}/{caseNumber}", tenantId, year, caseType, caseNumber)
                        .contentType(MediaType.APPLICATION_JSON));
    }
}
