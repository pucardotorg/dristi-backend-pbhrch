...
public class IndexerUtilsTest {
    ...
    @InjectMocks
    private org.pucar.dristi.caselifecycle.analytics.internal.util.IndexerUtils indexerUtils;
    ...
    public void testIsNullOrEmpty() {
        assertTrue(org.pucar.dristi.caselifecycle.analytics.internal.util.IndexerUtils.isNullOrEmpty(null));
        assertTrue(org.pucar.dristi.caselifecycle.analytics.internal.util.IndexerUtils.isNullOrEmpty(""));
        assertTrue(org.pucar.dristi.caselifecycle.analytics.internal.util.IndexerUtils.isNullOrEmpty(" "));
        assertFalse(org.pucar.dristi.caselifecycle.analytics.internal.util.IndexerUtils.isNullOrEmpty("test"));
    }
