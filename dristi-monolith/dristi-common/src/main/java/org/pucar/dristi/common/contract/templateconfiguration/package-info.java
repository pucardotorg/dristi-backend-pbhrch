/**
 * Templateconfiguration subdomain's contract DTOs — request/response envelopes plus their
 ...
 */
@org.springframework.modulith.NamedInterface("contract-templateconfiguration")
