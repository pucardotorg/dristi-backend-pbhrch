/**
 * Bank subdomain's contract DTOs — request/response envelopes plus their
 ...
 */
@org.springframework.modulith.NamedInterface("contract-bank")
package org.pucar.dristi.common.contract.bank;
