...
/**
 * Constants needed by classes living in dristi-common.
 *
 * <p>Values mirror the legacy DRISTI service ServiceConstants so behavior
 * stays identical. Each service may keep its own ServiceConstants for
 * service-specific values; this class only contains the union actually
 * referenced by the canonical utilities.
 */
public final class CommonConstants {

    private CommonConstants() {}

    // Generic exception markers
    ...
    // MDMS
    public static final String ERROR_WHILE_FETCHING_FROM_MDMS =
            "Exception occurred while fetching category lists from mdms: ";
    ...
    public static final String FAILED_TO_PARSE_BUSINESS_SERVICE_SEARCH =
    ...
    public static final String OBJECTMAPPER_UNABLE_TO_CONVERT =
            "Unable to convert object via Jackson ObjectMapper";
}
