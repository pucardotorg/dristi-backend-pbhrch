package org.pucar.dristi.integration.summons.internal.enrichment;
...
public class SummonsDeliveryEnrichment {
    ...
    public SummonsDelivery generateAndEnrichSummonsDelivery(Task task, RequestInfo requestInfo) {
        ...
        String id = idgenUtil.getIdList(requestInfo, task.getTenantId(), config.getSummonsIdFormat(), null, 1, false).get(0);
