...
import org.pucar.dristi.integration.njdg.internal.model.order.OrderCriteria;
...
import org.pucar.dristi.integration.njdg.internal.utils.*;
...
public class NJDGCaseTransformerImpl implements CaseTransformer {
    ...
    private final NjdgDateHelper dateUtil;
