...
@Component("njdgFileStoreHelper")
@Slf4j
public class NjdgFileStoreHelper {
    ...
    @Autowired
    public NjdgFileStoreHelper(RestTemplate restTemplate, TransformerProperties configs, ObjectMapper mapper) {
