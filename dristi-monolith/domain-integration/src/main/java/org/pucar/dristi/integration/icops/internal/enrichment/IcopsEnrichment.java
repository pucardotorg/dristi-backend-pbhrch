package org.pucar.dristi.integration.icops.internal.enrichment;
...
import org.pucar.dristi.integration.icops.internal.repository.IcopsRepository;
import org.pucar.dristi.integration.icops.internal.util.*;
...
import static org.pucar.dristi.integration.icops.internal.config.ServiceConstants.*;
...
public class IcopsEnrichment {
    ...
    public IcopsEnrichment(FileStorageUtil fileStorageUtil, IcopsConfiguration config,
                           DateStringConverter converter, MdmsUtil util, @Qualifier("commonIdgenUtil") IdgenUtil idgenUtil, IcopsRepository repository, ObjectMapper objectMapper) {
    ...
    public ProcessRequest getProcessRequest(TaskRequest taskRequest) throws JsonProcessingException {
        ...
        String processUniqueId = idgenUtil.getIdList(taskRequest.getRequestInfo(), config.getEgovStateTenantId(),
                config.getIdName(), null, 1, null).get(0);
